...
description: Configure the database for Sinerr
sidebar_position: 2
---
# Configuring the Database

Sinerr supports SQLite and PostgreSQL. The database connection can be configured using the following environment variables:
...
DB_NAME="sinerr" # (optional) The name of the database to connect to. The default is "sinerr".
...
1. Set up your PostgreSQL database and configure Sinerr to use it
2. Run Sinerr to create the tables in the PostgreSQL database
3. Stop Sinerr
...
**Recommended method**: Use the pgloader container even for standalone Sinerr installations. This avoids building from source and ensures compatibility.
