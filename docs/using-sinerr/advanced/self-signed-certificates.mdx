...
If your media server or services use self-signed SSL certificates, Sinerr will reject the connection because it does not trust them by default. The fix is to add your CA certificate to Node.js.
