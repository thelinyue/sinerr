...
:::info
If the [Application URL](/using-sinerr/settings/general#application-title) setting is configured in **Settings â†?General**, Sinerr will explicitly set the origin server hostname when connecting to the SMTP host.
:::
