---
title: General
description: Configure global and default settings for Sinerr.
sidebar_position: 1
---
...
This is your Sinerr API key, which can be used to integrate Sinerr with third-party applications. Do **not** share this key publicly, as it can be used to gain administrator access!
...
If you aren't a huge fan of the name "Sinerr" and would like to display something different to your users, you can customize the application title!

## Application URL

Set this to the externally-accessible URL of your Sinerr instance.
...
Set the default display language for Sinerr. Users can override this setting in their user settings.
