...
<Tabs groupId="unraid-permissions" queryString>
  <TabItem value="seerr-default" label="Sinerr Default">
  ...
  |---|---|
  | **Name** | `seerr` |
  | **Repository** | `ghcr.io/Linyue-GitHub/sinerr:latest` |
  | **Icon URL** | `https://raw.githubusercontent.com/Linyue-GitHub/sinerr/develop/public/android-chrome-512x512.png` |
