...
You can start, stop, and restart Sinerr from **Package Center** → Find Sinerr → Use the action buttons.
...
Sinerr logs are located at `/var/packages/seerr/var/config/logs` and can be accessed using:
