...
Enable this setting to connect to Jellyfin via HTTPS rather than HTTP. Self-signed certificates are not trusted by default, but you can configure Sinerr to accept them. See [Self-Signed Certificates](/using-seerr/advanced/self-signed-certificates) for details.
...
Enable this setting to connect to Emby via HTTPS rather than HTTP. Self-signed certificates are not trusted by default, but you can configure Sinerr to accept them. See [Self-Signed Certificates](/using-seerr/advanced/self-signed-certificates) for details.
...
Enable this setting to connect to Plex via HTTPS rather than HTTP. Self-signed certificates are not trusted by default, but you can configure Sinerr to accept them. See [Self-Signed Certificates](/using-seerr/advanced/self-signed-certificates) for details.
