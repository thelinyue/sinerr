...
<!-- We are releasing **Sinerr v3.3.0**,  -->
This release note covers both **v3.2.0** and **v3.3.0** releases, which include a host of new features, improvements, and bug fixes to enhance your Sinerr experience.
...
Many thanks to those making their first contribution to Sinerr in v3.2.0 and v3.3.0:
