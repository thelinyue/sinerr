...
## Why does Sinerr default to UID/GID `1000:1000`?
...
As for why we don't go into more depth on this in our docs: we focus on the basics and the most common use cases for Sinerr itself. Docker's permission model, including how the `USER` directive works, is already well documented by Docker. Our goal is to get you up and running smoothly, while encouraging you to explore the tools you're using.
