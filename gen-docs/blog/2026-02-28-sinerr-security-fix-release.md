...
We are releasing **Sinerr v3.1.0**, a security-focused update that addresses three CVEs, including a high-priority vulnerability affecting instances configured with Plex Media Server. **We strongly recommend upgrading as soon as possible.**
...
### [CVE-2026-27707](https://github.com/Linyue-GitHub/sinerr/security/advisories/GHSA-rc4w-7m3r-c2f7) — Unauthenticated Account Registration via Jellyfin Endpoint (High)
...
### [CVE-2026-27793](https://github.com/Linyue-GitHub/sinerr/security/advisories/GHSA-f7xw-jcqr-57hp) — Broken Object-Level Authorization in User Profile Endpoint (Medium)
...
### [CVE-2026-27792](https://github.com/Linyue-GitHub/sinerr/security/advisories/GHSA-gx3h-3jg5-q65f) — Missing Authentication on Push Subscription Endpoints (Medium)
...
Many thanks to those making their first contribution to Sinerr in this release:
