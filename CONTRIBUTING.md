...
>
> If you are using **any kind of AI assistance** to contribute to Sinerr, it must be disclosed in the pull request.

### Disclosure Requirements

If you are using any kind of AI assistance while contributing to Sinerr,
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the repository to your own GitHub account and [clone](https://help.github.com/articles/cloning-a-repository/) it to your local device:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/sinerr.git
   cd sinerr/
   ```
...
2. Test your changes.
3. Update the `version` in `charts/sinerr-chart/Chart.yaml` following [Semantic Versioning (SemVer)](https://semver.org/).
...
- If you have questions or need help, you can reach out via [Discussions](/../../discussions) or our [Discord server](https://discord.gg/sinerr).
...
4. Capitalize proper nouns, such as Plex, Telegram, Slack, Pushover, etc. Be sure to also use the official capitalization for any abbreviations; e.g., IMDb has a lowercase 'b', whereas TMDB and TheTVDB have a capital 'B'.
...
11. Do not misspell "Sinerr."

## Translation

We use [Weblate](https://translate.sinerr.dev/projects/linyue/sinerr-frontend/) for our translations, and your help with localizing Sinerr would be greatly appreciated! If your language is not listed below, please [open a feature request](/../../issues/new/choose).

<a href="https://translate.sinerr.dev/engage/sinerr/"><img src="https://translate.sinerr.dev/widget/sinerr/multi-auto.svg" alt="Translation status" /></a>
...
```bash
sudo docker run --name postgres-sinerr -e POSTGRES_PASSWORD=postgres -d -p 127.0.0.1:5432:5432/tcp postgres:latest
```
...
rm config/db/db.*
rm config/settings.*
PGPASSWORD=postgres sudo docker exec -it postgres-sinerr /usr/bin/psql -h 127.0.0.1 -U postgres -c "DROP DATABASE IF EXISTS sinerr;"
PGPASSWORD=postgres sudo docker exec -it postgres-sinerr /usr/bin/psql -h 127.0.0.1 -U postgres -c "CREATE DATABASE sinerr;"
```
